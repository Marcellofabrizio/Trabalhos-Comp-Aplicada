...
author: "Leonardo Martelli e Marecello Fabrizio"
date: "06/09/2021"
output:
  html_document:
    df_print: paged
...
Para facilitar a visualização de se as variáveis contêm *outliers*, gráficos do tipo *boxplot* pode auxiliar. Os seguintes gráficos foram gerados em grupos de 4, com exceção da variável *Class*, a qual é o fator de classificação.
